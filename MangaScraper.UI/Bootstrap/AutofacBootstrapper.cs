...
namespace MangaScraper.UI.Bootstrap {
  ...
  public class AutofacBootstrapper<TRootViewModel> : BootstrapperBase {
    ...
    /// </remarks>
    /// </summary>
    protected override void Configure() { //  allow base classes to change bootstrapper settings
      ...
      builder.RegisterAssemblyTypes(AssemblySource.Instance.ToArray())
        ...
        .Where(type => !EnforceNamespaceConvention || type.Namespace?.EndsWith("ViewModels") == true)
      ...
      builder.RegisterAssemblyTypes(AssemblySource.Instance.ToArray())
        ...
        .Where(type => !EnforceNamespaceConvention || type.Namespace?.EndsWith("Views") == true)
        //  registered as self
        .AsSelf()
        //  always create a new one
        .InstancePerDependency();
    ...
    protected void DisplayRoot(IDictionary<string, object> settings = null) => DisplayRootViewFor<TRootViewModel>(settings);
    ...
    /// </summary>
    protected virtual void ConfigureBootstrapper() { //  by default, enforce the namespace convention
      EnforceNamespaceConvention = true;
